...
/// 参考:http://kan-kikuchi.hatenablog.com/entry/AudioManager2
...
///参考
///ベース:http://geekhack.mods.jp/geek-hack/2016/01/02/post-56/
///拡張:
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        /// シングルトン用変数
        /// </summary>
        private static AudioManager _mInstance = null;       
        ...
        public static AudioManager Instance
        {
            get
            {
                if (_mInstance == null)
                {
                    ...
                    _mInstance = obj.AddComponent<AudioManager>();
                }
                return _mInstance;
            }
        }
